...
class TestChangeBoot(TestBase):
    ...
    @patch("aiohttp.ClientSession.get")
    def test_change_boot_incorrect_path(self, mock_get):
        responses = INIT_RESP
        self.set_mock_response(mock_get, 200, responses)
    ...
    @patch("aiohttp.ClientSession.patch")
    @patch("aiohttp.ClientSession.get")
    def test_change_boot_patch_error(self, mock_get, mock_patch, mock_post):
        get_resp = [
            BOOT_MODE_RESP,
            self.boot_seq_resp_fmt_dir.replace("'", '"'),
            BLANK_RESP,
    ...
    @patch("aiohttp.ClientSession.patch")
    @patch("aiohttp.ClientSession.get")
    def test_change_boot_less_valid_devices(self, mock_get, mock_patch, mock_post):
    ...
    @patch("aiohttp.ClientSession.patch")
    @patch("aiohttp.ClientSession.get")
    def test_change_boot_pxe(self, mock_get, mock_patch, mock_post):
        get_resp = [
            BOOT_MODE_RESP,
            self.boot_seq_resp_fmt_dir.replace("'", '"'),
            BLANK_RESP,
