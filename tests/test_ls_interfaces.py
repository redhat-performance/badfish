...
from tests.config import (
    ...
    DEVICE_NIC_I,
    DEVICE_NIC_S,
    RESPONSE_LS_INTERFACES, ETHERNET_INTERFACES_RESP, ETHERNET_INTERFACES_RESP_NIC_SLOT,
    ETHERNET_INTERFACES_RESP_NIC_INT, RESPONSE_RESET_FAIL, RESPONSE_LS_ETHERNET,
)
